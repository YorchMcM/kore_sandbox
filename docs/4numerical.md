...
For a fully defined problem, the differential equation(s) discretized above need to be complemented with boundary conditions, all of which are discretized in exactly the same manner. NO ENTIENDO LAS CONDICIONES DE CONTORNO. F MAYÚSCULA.
